...
./trtexec --onnx="/home/ps/workspace/trt/trt-sahi-yolo/workspace/pretrain/yolov8s-seg.transd.onnx" \
            --saveEngine="/home/ps/workspace/trt/trt-sahi-yolo/workspace/pretrain/yolov8s-seg.transd.trtmodel" \
